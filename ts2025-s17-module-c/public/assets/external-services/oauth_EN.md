...
Available by address: `http://localhost:7000`. See `readme.md` for starting external services.
...
A hidden, default app is already registered, with client id `cid-123412341234` and client secret `csec-123443211234`. This app allows any redirect uri.
